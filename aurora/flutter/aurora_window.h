...
//
//  Aurora OS platform window header
//

#ifndef AURORA_WINDOW_H_
#define AURORA_WINDOW_H_
...
class AuroraWindow : public QObject
{
    Q_OBJECT
...
public:
    explicit AuroraWindow(QObject *parent = nullptr);
